...
digital_out Coloring = digital_out(Brain.ThreeWirePort.A);
digital_out Blockingle = digital_out(Brain.ThreeWirePort.B);
digital_out FlippyDownyThingy = digital_out(Brain.ThreeWirePort.C);
...
smartdrive Drivetrain = smartdrive(LeftDriveSmart, RightDriveSmart, DrivetrainInertial, 299.24, 320, 40, mm, 0.75);
